...
1. Copy the wrapper script `scripts/sync-upstream.sh` into your target repository and make it executable.
2. Edit the environment variables in `sync-upstream.sh` to point to your specific upstream and target repositories.
3. Add the tiny proxy GitHub Action workflows to your `.github/workflows/` directory that `uses:` the reusable workflows in this repository.
